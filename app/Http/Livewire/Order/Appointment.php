...
class Appointment extends Component
{
    ...
    public function render()
    {
        $days = [
            [
                'day' => Carbon::now()->addDays(1)->translatedFormat('Y-m-d'),
                'label' => Carbon::now()->addDays(1)->translatedFormat('l, d F Y')
            ],
            [
                'day' => Carbon::now()->addDays(2)->translatedFormat('Y-m-d'),
                'label' => Carbon::now()->addDays(2)->translatedFormat('l, d F Y')
            ]
        ];
